...
cfg.datasets.train.path = '/media/psrahul/My_Drive/my_files/Academic/TUM/Assignments/DI_Lab/Phase1/data/val2017/'  #train2017/'             # Training data path (COCO dataset)
cfg.datasets.train.repeat = 1                                          # Number of times training dataset is repeated per epoch
########################################################################################################################
### DATASETS.VAL
########################################################################################################################
cfg.datasets.val = CN()
cfg.datasets.val.path = 'kp2d/datasets/HPatches/'     # Validation data path (HPatches)
########################################################################################################################
