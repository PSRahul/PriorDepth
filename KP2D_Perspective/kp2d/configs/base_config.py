...
cfg.arch.epochs = 10 #50                # Maximum number of epochs
########################################################################################################################
### WANDB
########################################################################################################################
cfg.wandb = CN()
...
########################################################################################################################
cfg.model = CN()
cfg.model.checkpoint_path = 'experiments/kp2d_kitti2/'              # Checkpoint path for model saving
...
cfg.datasets.train.path = '/home/ubuntu/PriorDepth/datasets/kitti_eigen_zhou_split/images/'        # Training data path (COCO dataset)
